...
to {
  ...
  animation: ${P} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,C=({toast:t})=>{let{icon:a,type:r,iconTheme:o}=t;return void 0!==a?"string"==typeof a?e.createElement(A,null,a):a:"blank"===r?null:e.createElement(I,null,e.createElement($,{...o}),"loading"!==r&&e.createElement(O,null,"error"===r?e.createElement(w,{...o}):e.createElement(z,{...o})))},N=e=>`\n0% {transform: translate3d(0,${-200*e}%,0) scale(.6); opacity:.5;}\n100% {transform: translate3d(0,0,0) scale(1); opacity:1;}\n`,j=e=>`\n0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}\n100% {transform: translate3d(0,${-150*e}%,-1px) scale(.6); opacity:0;}\n`,M=r("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
