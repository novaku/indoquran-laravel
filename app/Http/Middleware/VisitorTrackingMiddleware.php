    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (
            ...
            try {
                ...
                if (!$recentVisit) {
                    // Create visitor record in background
                    dispatch(function () use ($ipAddress, $userAgent, $pageUrl, $referrer, $sessionId) {
                        try {
                            Visitor::create([
                ...
                \Log::error('Error in visitor tracking middleware: ' . $e->getMessage());
            }
        }
