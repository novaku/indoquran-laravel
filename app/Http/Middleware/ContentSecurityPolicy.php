    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (app()->environment('local')) {
            $csp = implode('; ', [
                ...
                "connect-src 'self' ws://localhost:5173 ws://127.0.0.1:5173 ws://localhost:5174 ws://127.0.0.1:5174 http://localhost:5173 http://127.0.0.1:5173 http://localhost:5174 http://127.0.0.1:5174 http://localhost:8000 http://127.0.0.1:8000 http://localhost https://my.indoquran.web.id https://download.quranicaudio.com https://nominatim.openstreetmap.org https://api.quran.com https://*.google-analytics.com https://www.google-analytics.com https://www.googletagmanager.com https://tagmanager.google.com https://analytics.google.com https://cdn.jsdelivr.net",
            ...
            $csp = implode('; ', [
                ...
                "img-src 'self' data: blob: https://*.google-analytics.com https://www.google-analytics.com https://*.googlesyndication.com https://*.google.com",
                "media-src 'self' https://*.nos.wjv-1.neo.id https://*.equran.id https://*.equran.nos.wjv-1.neo.id https://*.quranicaudio.com https://*.qurancdn.com https://*.vercel.app *",
                "connect-src 'self' https://download.quranicaudio.com https://my.indoquran.web.id https://nominatim.openstreetmap.org https://api.quran.com https://*.google-analytics.com https://www.google-analytics.com https://www.googletagmanager.com https://tagmanager.google.com https://analytics.google.com",
