...
class ContentSecurityPolicy
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (app()->environment('local')) {
            $csp = implode('; ', [
                "default-src 'self'",
                "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https://indoquran.web.id http://localhost:5173 http://127.0.0.1:5173 http://localhost:5174 http://127.0.0.1:5174 http://localhost:8000 http://127.0.0.1:8000 http://localhost ws://localhost:5173 ws://127.0.0.1:5173 ws://localhost:5174 ws://127.0.0.1:5174 https://*.google-analytics.com https://www.google-analytics.com https://www.googletagmanager.com https://tagmanager.google.com https://analytics.google.com https://*.googlesyndication.com https://*.google.com https://cdn.jsdelivr.net https://unpkg.com",
                "script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https://indoquran.web.id http://localhost:5173 http://127.0.0.1:5173 http://localhost:5174 http://127.0.0.1:5174 http://localhost:8000 http://127.0.0.1:8000 http://localhost ws://localhost:5173 ws://127.0.0.1:5173 ws://localhost:5174 ws://127.0.0.1:5174 https://*.google-analytics.com https://www.google-analytics.com https://www.googletagmanager.com https://tagmanager.google.com https://analytics.google.com https://*.googlesyndication.com https://*.google.com https://cdn.jsdelivr.net https://unpkg.com",
                "style-src 'self' 'unsafe-inline' blob: data: https://indoquran.web.id http://localhost:5173 http://127.0.0.1:5173 http://localhost:5174 http://127.0.0.1:5174 http://localhost:8000 http://127.0.0.1:8000 http://localhost https://fonts.bunny.net https://fonts.googleapis.com https://cdn.jsdelivr.net",
                "font-src 'self' data: blob: http://localhost:8000 http://127.0.0.1:8000 http://localhost:5173 http://127.0.0.1:5173 http://localhost:5174 http://127.0.0.1:5174 http://localhost https://fonts.bunny.net https://fonts.gstatic.com https://indoquran.web.id https://cdn.jsdelivr.net",
                ...
                "connect-src 'self' ws://localhost:5173 ws://127.0.0.1:5173 ws://localhost:5174 ws://127.0.0.1:5174 http://localhost:5173 http://127.0.0.1:5173 http://localhost:5174 http://127.0.0.1:5174 http://localhost:8000 http://127.0.0.1:8000 http://localhost https://indoquran.web.id https://download.quranicaudio.com https://nominatim.openstreetmap.org https://api.quran.com https://*.google-analytics.com https://www.google-analytics.com https://www.googletagmanager.com https://tagmanager.google.com https://analytics.google.com https://cdn.jsdelivr.net",
