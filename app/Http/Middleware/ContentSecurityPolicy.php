...
class ContentSecurityPolicy
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (app()->environment('local')) {
            $csp = implode('; ', [
                "default-src 'self'",
                "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https: http://localhost:* http://127.0.0.1:* ws://localhost:* ws://127.0.0.1:*",
                "script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https: http://localhost:* http://127.0.0.1:*",
                "style-src 'self' 'unsafe-inline' blob: data: https: http://localhost:* http://127.0.0.1:*",
                "font-src 'self' data: blob: https: http://localhost:* http://127.0.0.1:*",
            ...
            $csp = implode('; ', [
                ...
                "img-src 'self' data: blob: https: https://*.googleusercontent.com https://*.google-analytics.com https://www.google-analytics.com https://*.googlesyndication.com https://*.google.com https://*.doubleclick.net https://*.googleadservices.com",
                ...
                "connect-src 'self' https://download.quranicaudio.com https://indoquran.web.id https://nominatim.openstreetmap.org https://api.quran.com https://accounts.google.com https://*.google-analytics.com https://www.google-analytics.com https://www.googletagmanager.com https://tagmanager.google.com https://analytics.google.com https://*.googlesyndication.com https://*.google.com https://*.doubleclick.net https://*.googleadservices.com https://*.adtrafficquality.google https://pagead2.googlesyndication.com",
                "frame-src 'self' blob: https://accounts.google.com https://*.googlesyndication.com https://*.doubleclick.net https://*.google.com https://*.googleadservices.com https://*.adtrafficquality.google https://googleads.g.doubleclick.net https://tpc.googlesyndication.com",
