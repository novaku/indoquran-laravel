    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (app()->environment('local')) {
            $csp = implode('; ', [
                ...
                "font-src 'self' data: blob: https://fonts.bunny.net https://fonts.gstatic.com fonts.bunny.net fonts.gstatic.com https://*.indoquran.web.id my.indoquran.web.id https://my.indoquran.web.id",
