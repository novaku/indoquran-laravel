...
function HomePage() {
    ...
    const SurahCard = memo(({ surah, onSurahClick }) => {
        ...
        return (
            <div className="group bg-white rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden">
                {/* Background Pattern */}
                <div className="absolute top-0 right-0 w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-br from-islamic-green/5 to-islamic-gold/5 rounded-bl-3xl"></div>
                
                {/* Header Section */}
                <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                        <div className="w-12 sm:w-14 h-12 sm:h-14 bg-gradient-to-br from-islamic-green to-islamic-gold rounded-xl flex items-center justify-center text-white font-bold text-base sm:text-lg shadow-lg relative flex-shrink-0">
                            <span className="text-black font-bold drop-shadow-sm">{surah.number}</span>
                            <div className="absolute -top-1 -right-1 w-5 sm:w-6 h-5 sm:h-6 bg-islamic-gold rounded-full flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-2.5 sm:h-3 w-2.5 sm:w-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                            </div>
                        </div>
                        <div className="flex-1 min-w-0">
                            <h3 className="text-lg sm:text-xl font-bold text-islamic-green group-hover:text-islamic-gold transition-colors mb-1 truncate">
                                {surah.name_latin}
                            </h3>
                            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 text-xs sm:text-sm text-gray-600 space-y-1 sm:space-y-0">
                                <span className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 sm:h-4 w-3 sm:w-4 mr-1 text-islamic-green flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="text-right ml-2 sm:ml-4 flex-shrink-0">
                        <h4 className="text-xl sm:text-3xl font-arabic text-islamic-green mb-1 leading-none">{surah.name_arabic}</h4>
                        <p className="text-xs sm:text-sm text-gray-500 font-medium truncate max-w-[100px] sm:max-w-none">{surah.name_indonesian}</p>
                    </div>
                </div>
                
                {/* Description Section */}
                {surah.description_short && (
                    <div className="mb-4 p-3 sm:p-4 bg-gradient-to-r from-islamic-green/5 to-islamic-gold/5 rounded-xl border border-islamic-green/10">
                        <h5 className="text-xs sm:text-sm font-semibold text-islamic-green mb-2 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 sm:h-4 w-3 sm:w-4 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            Tentang Surah
                        </h5>
                        <p className="text-gray-600 text-xs sm:text-sm leading-relaxed line-clamp-3">
                            {truncateDescription(surah.description_short, 120)}
                        </p>
                    </div>
                )}
                
                {/* Action Buttons */}
                <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-gray-100 space-x-2 sm:space-x-3">
                    <button
                        onClick={handleDetailClick}
                        className="flex items-center px-3 sm:px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-600 hover:text-white transition-all duration-300 text-xs sm:text-sm font-medium shadow-sm flex-1 justify-center"
                    >
                    ...
                    <a 
                        ...
                        className="flex items-center px-3 sm:px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-300 text-xs sm:text-sm font-medium shadow-sm flex-1 justify-center"
    ...
    return (
        <>
            ...
            <PageTransition>
                <div className="min-h-screen bg-gradient-to-br from-islamic-green/5 to-islamic-gold/5 pb-20">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {/* Widget Pencarian */}
                        <div className="mb-6 sm:mb-8 mt-6 sm:mt-8 w-full">
                            <SearchField 
                                surahs={surahs}
                                ...
                                theme="islamic"
                            />
                            <p className="text-center text-xs sm:text-sm text-islamic-green/70 mt-2 sm:mt-3 px-2 flex items-center justify-center gap-1.5">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 sm:h-4 w-3 sm:w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span className="text-center">Cari berdasarkan kata kunci, nama surah, atau terjemahan bahasa Indonesia</span>
                            </p>
                        </div>
                        
                        {/* Running Text for Random Doa Bersama */}
                        <RunningTextWidget className="mb-6 sm:mb-8" />
                        
                        <PrayerTimesWidget className="mb-16 sm:mb-24 p-3 sm:p-4" />
                        
                        {/* Bagian Tab Fitur */}
                        <FeatureTabsSection className="mb-12 sm:mb-16 p-3 sm:p-4 mt-6 sm:mt-8" />
                    
                        <div className="mb-6 sm:mb-8">
                            <h1 className="text-2xl sm:text-3xl font-bold text-islamic-green mb-2">Al-Quran Digital</h1>
                            <p className="text-base sm:text-lg text-gray-600 mb-4 sm:mb-6">Baca, dengar, dan pelajari Al-Quran secara online dengan terjemahan bahasa Indonesia</p>
                        </div>
            ...
            {showModal && selectedSurah && (
                ...
                >
                    <div 
                        className="bg-white rounded-2xl sm:rounded-3xl p-0 max-w-5xl w-full max-h-[95vh] overflow-hidden shadow-2xl relative transform transition-all"
                        onClick={(e) => e.stopPropagation()}
                    >
                        {/* Header with Gradient Background */}
                        <div className="relative bg-gradient-to-r from-islamic-green to-islamic-gold text-black p-4 sm:p-6 lg:p-8 pb-8 sm:pb-12">
                            {/* Background Pattern */}
                            ...
                            <button 
                                onClick={closeModal}
                                className="absolute top-3 sm:top-4 right-3 sm:right-4 text-black/80 hover:text-black transition-colors p-2 rounded-full hover:bg-white/10"
                            >
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center mb-3 sm:mb-4">
                                    <div className="w-12 sm:w-16 h-12 sm:h-16 bg-white/20 rounded-xl sm:rounded-2xl flex items-center justify-center text-black font-bold text-lg sm:text-xl mr-3 sm:mr-4 backdrop-blur-sm">
                                        {selectedSurah?.number}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 text-black truncate">
                                            {selectedSurah?.name_latin || 'Surah'}
                                        </h2>
                                        <p className="text-black/90 text-sm sm:text-base lg:text-lg truncate">
                                ...
                                <div className="text-center mb-3 sm:mb-4">
                                    <h3 className="text-3xl sm:text-4xl lg:text-5xl font-arabic leading-none mb-2 text-black">
                        ...
                        {/* Action Buttons */}
                        <div className="p-4 sm:p-6 lg:p-8 border-t border-gray-100 bg-gradient-to-r from-gray-50/50 to-gray-50/80">
                            <div className="space-y-3 sm:space-y-4">
                                {/* Primary Action - Always full width */}
                                <button
                                    onClick={() => navigate(`/surah/${selectedSurah?.number}`)}
                                    className="w-full bg-gradient-to-r from-islamic-green to-emerald-600 hover:from-islamic-green/90 hover:to-emerald-600/90 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-lg sm:rounded-xl font-semibold text-base sm:text-lg flex items-center justify-center gap-2 sm:gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 active:scale-98 group"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 sm:h-6 w-5 sm:w-6 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                ...
                                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                                    <button
                                        ...
                                        className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-medium text-sm sm:text-base flex items-center justify-center gap-1.5 sm:gap-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 active:scale-98 group"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 sm:h-5 w-4 sm:w-5 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    ...
                                    <button
                                        onClick={closeModal}
                                        className="bg-white hover:bg-gray-50 border-2 border-gray-300 hover:border-gray-400 text-gray-700 hover:text-gray-800 py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-medium text-sm sm:text-base flex items-center justify-center gap-1.5 sm:gap-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 active:scale-98 group"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 sm:h-5 w-4 sm:w-5 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
