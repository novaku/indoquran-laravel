                                                                    ...
                                                                    <div className="flex flex-col space-y-1">
                                                                        <div className="flex items-center space-x-2">
                                                                            <p className="font-medium text-gray-900">
                                                                                {surah.surah_name || 
                                                                                 (surahNames[surah.surah_number] ? 
                                                                                  surahNames[surah.surah_number] : 
                                                                                  `Surah ${surah.surah_number}`)}
                                                                            </p>
                                                                            {/* For now, we'll add Indonesian names when available from backend */}
                                                                        </div>
                                                                        {(surah.surah_name_arabic || surah.arabic_name) && (
                                                                            <p className="text-sm text-gray-600" style={{ fontFamily: 'Amiri, Scheherazade, "Times New Roman", serif', direction: 'rtl' }}>
                                                                                {surah.surah_name_arabic || surah.arabic_name}
                                                                            </p>
                                                                        )}
                                                                    </div>
